...
public class IncidenceMessage {
    ...
    public String newActivity(User personalSupport,Incidence incidence, User personal) throws MessagingException {
        email="<!DOCTYPE html>\n" +
                "\n" +
                "<html lang=\"en\" xmlns:o=\"urn:schemas-microsoft-com:office:office\" xmlns:v=\"urn:schemas-microsoft-com:vml\">\n" +
                "\n" +
                ...
                "                        <div\n" +
                "                                style=\"color:#101112;font-size:16px;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-weight:400;line-height:120%;text-align:left;direction:ltr;letter-spacing:0px;mso-line-height-alt:19.2px;\">\n" +
                "                          <p style=\"margin: 0;\"> la incidencia: "+incidence.getTitle()+"<br> ha cambiado al estatus "+incidence.getStatus().getName()+"  y ahora el personal de soporte "+personal.getName()+" "+personal.getPrimerApellido()+" se está haciendo cargo de ella<br> " +
                "                               </p>\n" +
                "                        </div>\n" +
                "                      </td>\n" +
                "                    </tr>\n" +
                ...
                "                      <td class=\"pad\"\n" +
                "                          style=\"text-align:left;padding-top:10px;padding-right:15px;padding-bottom:10px;padding-left:30px;\">\n" +
                "                               <a href=\"http://44.205.171.247:3000//IncidenciasPendientes\"><button type=\"button\" style=\"color:#ffffff;background-color:#009475;border-radius:4px;width:auto;border-top:1px solid transparent;font-weight:400;border-right:1px solid transparent;border-bottom:1px solid transparent;border-left:1px solid transparent;\">Ir al sistema</button></a>\n" +
                "                           </td>\n" +
                "                    </tr>\n" +
                "                  </table>\n" +
                "                </td>\n" +
    ...
    public String newMessagechat(User personalSupport,Incidence incidence) throws MessagingException {
        email="<!DOCTYPE html>\n" +
                "\n" +
                "<html lang=\"en\" xmlns:o=\"urn:schemas-microsoft-com:office:office\" xmlns:v=\"urn:schemas-microsoft-com:vml\">\n" +
                "\n" +
                ...
                "                        <h2\n" +
                "                                style=\"margin: 0; color: #636365; font-size: 30px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; line-height: 120%; text-align: left; direction: ltr; font-weight: 700; letter-spacing: normal; margin-top: 0; margin-bottom: 0;\">\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"tinyMce-placeholder\">¡Hola! "+personalSupport.getName()+" Tienes un nuevo mensaje en tu incidencia: "+incidence.getTitle()+" </span></h2>\n" +
                "                      </td>\n" +
                "                    </tr>\n" +
                "                  </table>\n" +
                "                </td>\n" +
                ...
                "                        <div\n" +
                "                                style=\"color:#101112;font-size:16px;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-weight:400;line-height:120%;text-align:left;direction:ltr;letter-spacing:0px;mso-line-height-alt:19.2px;\">\n" +
                "                          <p style=\"margin: 0;\"> La incidencia: "+incidence.getTitle()+"<br> tiene nuevos mensajes que no has leido aun, te recomendamos que los leas para dar pronta solucion a la incidencia<br> " +
                "                               </p>\n" +
                "                        </div>\n" +
                "                      </td>\n" +
                "                    </tr>\n" +
