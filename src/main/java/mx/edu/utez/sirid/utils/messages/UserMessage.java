 ...
 String message;
    public String changePassWord(){
         this.message="<!DOCTYPE html>\n" +
                ...
                "                          <p style=\"margin: 0;\"><strong>Se ha modificado la\n" +
                "                            contraseña de su cuenta en el sistema de\n" +
                "                            reporte de incidencias para\n" +
                "                            docentes</strong></p>\n" +
                "                        </div>\n" +
                "                      </td>\n" +
                "                    </tr>\n" +
    ...
    public String recoverAccount(String name, String temporalPassword ){
         this.message="<!DOCTYPE html>\n" +
                "\n" +
                "<html lang=\"en\" xmlns:o=\"urn:schemas-microsoft-com:office:office\" xmlns:v=\"urn:schemas-microsoft-com:vml\">\n" +
                "\n" +
                ...
                "                        <h2\n" +
                "                                style=\"margin: 0; color: #636365; font-size: 30px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; line-height: 120%; text-align: left; direction: ltr; font-weight: 700; letter-spacing: normal; margin-top: 0; margin-bottom: 0;\">\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"tinyMce-placeholder\"> Hola!! "+name +".</span></h2>\n" +
                "                      </td>\n" +
                "                    </tr>\n" +
                "                  </table>\n" +
                "                </td>\n" +
                ...
                "                        <div\n" +
                "                                style=\"color:#101112;font-size:16px;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-weight:400;line-height:120%;text-align:left;direction:ltr;letter-spacing:0px;mso-line-height-alt:19.2px;\">\n" +
                "                          <p style=\"margin: 0;\"><strong> ¡Hubo una solicitud para cambiar su contraseña!</strong></p>\n" +
                "                        </div>\n" +
                "                      </td>\n" +
                "                    </tr>\n" +
                "                  </table>\n" +
                ...
                "                                style=\"color:#101112;font-size:16px;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-weight:400;line-height:120%;text-align:left;direction:ltr;letter-spacing:0px;mso-line-height-alt:19.2px;\">\n" +
                "                          <p style=\"margin: 0;\">" +
                 "                               Si no realizó esta solicitud, ignore este correo electrónico. <br><br>\n" +
                 "                                De lo contrario, esta es su contraseña de acceso temporal <strong>"+temporalPassword+"</strong><br><br> " +
                 "                                Ingrese usando el correo que tiene registrado en la " +
                 "                                plataforma para restablecer su contraseña  </p>\n" +
                "                        </div>\n" +
                "                      </td>\n" +
                "                    </tr>\n" +
                "                  </table>\n" +
    ...
    public String newAccount(String name,String contraseña){
        message="<!DOCTYPE html>\n" +
                ...
                "                        <h2\n" +
                "                                style=\"margin: 0; color: #636365; font-size: 30px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; line-height: 120%; text-align: left; direction: ltr; font-weight: 700; letter-spacing: normal; margin-top: 0; margin-bottom: 0;\">\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"tinyMce-placeholder\">Hola!! "+name+" Tu cuenta del Sistema de reporte de incidencias está lista</span></h2>\n" +
                "                      </td>\n" +
                "                    </tr>\n" +
                "                  </table>\n" +
                "                </td>\n" +
                ...
                "                        <div\n" +
                "                                style=\"color:#101112;font-size:16px;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-weight:400;line-height:120%;text-align:left;direction:ltr;letter-spacing:0px;mso-line-height-alt:19.2px;\">\n" +
                "                          <p style=\"margin: 0;\"><strong>Se ha activado una cuenta para el Sistema de reporte de incidencias</strong></p>\n" +
                "                        </div>\n" +
                "                      </td>\n" +
                "                    </tr>\n" +
                "                  </table>\n" +
    ...
    public String requestChanges(String name, User user){
        message="<!DOCTYPE html>\n" +
                "\n" +
                "<html lang=\"en\" xmlns:o=\"urn:schemas-microsoft-com:office:office\" xmlns:v=\"urn:schemas-microsoft-com:vml\">\n" +
                "\n" +
                ...
                "                        <h2\n" +
                "                                style=\"margin: 0; color: #636365; font-size: 30px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; line-height: 120%; text-align: left; direction: ltr; font-weight: 700; letter-spacing: normal; margin-top: 0; margin-bottom: 0;\">\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"tinyMce-placeholder\">¡Hola! "+name+" Tienes una nueva solicitud de cambios para el usuario "+user.getName()+" </span></h2>\n" +
                "                      </td>\n" +
                "                    </tr>\n" +
                "                  </table>\n" +
                "                </td>\n" +
                ...
                "                        <div\n" +
                "                                style=\"color:#101112;font-size:16px;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-weight:400;line-height:120%;text-align:left;direction:ltr;letter-spacing:0px;mso-line-height-alt:19.2px;\">\n" +
                "                          <p style=\"margin: 0;\">Estos son los datos por los que desea modificar su registro <br>" +
                "                                                  <Strong>Nombre </Strong> "+user.getName()+"<br><Strong>Primer Apellido </Strong> "+user.getPrimerApellido()+"<br> <Strong>Primer Segundo </Strong> "+user.getSegundoApellido()+"</p>\n" +
                "                        </div>\n" +
                "                      </td>\n" +
                "                    </tr>\n" +
                "                  </table>\n" +
